...
void phoJetNtuplizer::initTriggerFilters(const edm::Event &e) {
  ...
  e.getByToken(trgResultsToken_, trgResultsHandle);
...
ULong64_t phoJetNtuplizer::matchSingleElectronTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchDoubleElectronTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchSinglePhotonTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchDoublePhotonTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchTriplePhotonTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchMuonTriggerFilters(double pt, double eta, double phi) {
...
ULong64_t phoJetNtuplizer::matchL1TriggerFilters(double pt, double eta, double phi) {
...
Double_t phoJetNtuplizer::deltaPhi(Double_t phi1, Double_t phi2) {
...
Double_t phoJetNtuplizer::deltaR(Double_t eta1, Double_t phi1, Double_t eta2, Double_t phi2) {
